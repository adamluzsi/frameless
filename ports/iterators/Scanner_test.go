...
func TestScanner_SingleLineGiven_EachLineFetched(t *testing.T) {
	...
	i := iterators2.Scanner[string](bufio.NewScanner(readCloser), readCloser)
...
func TestScanner_nilCloserGiven_EachLineFetched(t *testing.T) {
	...
	i := iterators2.Scanner[string](bufio.NewScanner(readCloser), nil)
...
func ExampleScanner_Split() *iterators2.ScannerIter[string] {
	reader := strings.NewReader("a\nb\nc\nd")
	i := iterators2.Scanner[string](bufio.NewScanner(reader), nil)
...
func TestScanner_Split(t *testing.T) {
	...
	lines, err := iterators2.Collect[string](i)
