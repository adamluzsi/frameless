...
func (c FileSystem) specOpenFile(s *testcase.Spec) {
	...
	subject := func(t *testcase.T) (frameless.File, error) {
...
func (c FileSystem) andForTheExistingFileOpening(s *testcase.Spec, subject func(t *testcase.T) (frameless.File, error),
...
func (c FileSystem) andForAbsentFileOpening(s *testcase.Spec, subject func(t *testcase.T) (frameless.File, error), flag testcase.Var[int]) {
...
func (c FileSystem) thenCanBeWritten(s *testcase.Spec, subject func(t *testcase.T) (frameless.File, error),
	flag testcase.Var[int],
...
func (c FileSystem) writeToFile(t *testcase.T, file frameless.File, data []byte) {
	t.Helper()
