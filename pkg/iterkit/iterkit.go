...
func Error[T any](err error, errFuncs ...ErrFunc) (iter.Seq[T], ErrFunc) {
	return toIterSeqWithRelease(&errorIter[T]{err}, errFuncs...)
}

// ErrorF behaves exactly like fmt.ErrorF but returns the error wrapped as iterator
func ErrorF[T any](format string, a ...any) (iter.Seq[T], ErrFunc) {
...
func toIterSeqWithRelease[V any](i statefulIteratorWithError[V], errFuncs ...ErrFunc) (iter.Seq[V], ErrFunc) {
	var (
		returnError error
		errFunc     = func() error {
			return returnError
...
type pullable[T any] interface {
	iter.Seq[T] | func() (T, bool)
}

func pull[T any, I pullable[T]](i I) (func() (T, bool), func()) {
	switch v := any(i).(type) {
	case iter.Seq[T]:
		return iter.Pull(v)
	case func() (T, bool):
...
func OnErrIterValue[To any, From any](itr ErrIter[From], pipeline func(i iter.Seq[From]) iter.Seq[To]) ErrIter[To] {
