...
- Participants and Conditions are defined as Go functions, and process definitions are built using a set of composable workflow types that can be serialized into JSON.
