...
const executeParticipantJSONType jsonkit.TypeID = "workflow::execute-participant"

var _ = jsonkit.RegisterTypeID[ExecuteParticipant](executeParticipantJSONType)

type dtoJSONExecuteParticipant struct {
...
func (d ExecuteParticipant) MarshalJSON() ([]byte, error) {
	return json.Marshal(dtoJSONExecuteParticipant{
		Type:   executeParticipantJSONType.String(),
		ID:     d.ID,
		Input:  d.Input,
		Output: d.Output,
	})
...
func (d *ExecuteParticipant) UnmarshalJSON(data []byte) error {
	var dto dtoJSONExecuteParticipant
	if err := json.Unmarshal(data, &dto); err != nil {
		return err
	}
	*d = ExecuteParticipant{
		ID:     dto.ID,
		Input:  dto.Input,
		Output: dto.Output,
	}
...
var _ Event = (*ExecuteParticipantEvent)(nil)

var _ = jsonkit.RegisterTypeID[ExecuteParticipantEvent]("workflow::execute-participant-event")
