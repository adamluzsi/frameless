...
type Interface[ENT, ID any] interface {
	...
	CachedQueryMany(ctx context.Context, hid HitID, query QueryManyFunc[ENT]) (iter.Seq[ENT], func() error, error)
...
type (
	...
	QueryManyFunc[ENT any] func(ctx context.Context) (iter.Seq[ENT], func() error, error)
)
