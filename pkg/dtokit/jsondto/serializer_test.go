...
var (
	_ codec.Serializer       = jsondto.Serializer{}
	_ codec.ListDecoderMaker = jsondto.Serializer{}
	_ codec.ListEncoderMaker = jsondto.Serializer{}
)
...
func TestJSONSerializer_NewListDecoder(t *testing.T) {
	t.Run("E2E", func(t *testing.T) {
		...
		dec := jsondto.Serializer{}.MakeListDecoder(io.NopCloser(bytes.NewReader(data)))
...
func TestJSONSerializer_NewListEncoder(t *testing.T) {
	t.Run("E2E", func(t *testing.T) {
		...
		var buf bytes.Buffer
		enc := jsondto.Serializer{}.MakeListEncoder(&buf)
