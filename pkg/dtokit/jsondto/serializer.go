...
func (s Serializer) Unmarshal(data []byte, dtoPtr any) error {
	return json.Unmarshal(data, &dtoPtr)
}

func (s Serializer) MakeListEncoder(w io.Writer) codec.ListEncoder {
	return &jsonListEncoder{W: w}
}

func (s Serializer) MakeListDecoder(r io.Reader) codec.ListDecoder {
