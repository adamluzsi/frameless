...
func Test_createAndOpen(t *testing.T) {
	...
	assert.True(t, fileInfo.Mode()&filesystem.ModeUserRW != 0)
...
func TestReadDir(t *testing.T) {
	...
	assert.NoError(t, fsys.Mkdir(dirName, filesystem.ModeUserRWX))
...
func TestWalkDir(t *testing.T) {
	...
	assert.NoError(t, fsys.Mkdir("a", filesystem.ModeUserRWX))
	touchFile(t, "a/1")
	touchFile(t, "a/2")
	touchFile(t, "a/3")
	assert.NoError(t, fsys.Mkdir("b", filesystem.ModeUserRWX))
	touchFile(t, "b/4")
	touchFile(t, "b/5")
	touchFile(t, "b/6")
	assert.NoError(t, fsys.Mkdir("a/c", filesystem.ModeUserRWX))
	touchFile(t, "a/c/7")
	touchFile(t, "a/c/8")
	touchFile(t, "a/c/9")
